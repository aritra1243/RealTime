// =============================================================================
// PotholeVision — Monochrome Tactical Control Sidebar (Mobile Drawer Support)
// =============================================================================

import { Sliders, Layers, Sparkles, Cpu, Check, RefreshCw, X } from 'lucide-react';
...
export default function Sidebar({
  ...
  return (
    <>
      ...
      {/* ─── Sidebar Drawer (Desktop Sticky + Mobile Slide-Over) ─────────────── */}
      <aside
        className={`
          fixed top-0 bottom-0 left-0 z-50 w-80 max-w-[85vw] flex flex-col gap-5 border-r border-white/15 bg-zinc-950 p-5 backdrop-blur-2xl shadow-2xl transition-transform duration-300 ease-in-out
          lg:static lg:z-auto lg:w-72 lg:max-w-none lg:flex-shrink-0 lg:rounded-2xl lg:border lg:border-white/10 lg:bg-zinc-950/80 lg:shadow-2xl lg:translate-x-0
      ...
      >
        ...
        <div className="flex items-center justify-between border-b border-white/10 pb-3">
          ...
          <button
            onClick={onClose}
            className="rounded-lg p-1 text-zinc-400 hover:bg-zinc-900 hover:text-white lg:hidden cursor-pointer"
